  ...
  return (
    <div className="mb-20" id="about">
      ...
      <p className="section-content text-center">
        ...
        maintainable code and showcasing strong interpersonal and communication
        skills. I excel in collaborating with team members to achieve project
        objectives and have a strong command of software development principles.
      </p>
    </div>
  );
};
